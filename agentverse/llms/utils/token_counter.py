...
def count_string_tokens(prompt: str = "", model: str = "gpt-35-turbo") -> int:
    if model.startswith("gpt-35-turbo") or model.startswith("gpt-4"):
...
def count_message_tokens(
    messages: Union[Dict, List[Dict]], model: str = "gpt-35-turbo"
) -> int:
