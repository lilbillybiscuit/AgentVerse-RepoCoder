...
class CONSTANTS:
    ...
    sim_benchmark = 'sim_assign'
    sim1_benchmark = 'sim_assign1'
    rand_benchmark = 'rand_assign'
    ast_benchmark = 'ast_assign'
...
class FilePathBuilder:
    ...
    sim_assign_completion_benchmark = 'datasets/sim_strategy_smaller/singleGen_sim_ws30_leaveout0.jsonl'
    sim_assign1_completion_benchmark = 'datasets/sim_strategy_smaller/singleGen_sim_ws30_leaveout1.jsonl'
    ast_assign_completion_benchmark = '/home/yz979/CodeT/RepoCoder/datasets/ast_strategy_smaller/singleGen_ast_ws30.jsonl'
    rand_assign_completion_benchmark = 'datasets/rand_strategy_smaller/singleGen_rand_ws30.jsonl'
    ...
    def search_first_window_path(benchmark, mode, repo, window_size):
        ...
        FilePathBuilder.make_needed_dir(out_path)
        print("search_first_window_path", out_path)
        return out_path
    ...
    def one_gram_vector_path(window_file):
        ...
        FilePathBuilder.make_needed_dir(out_path)
        print("one_gram_vector_path", out_path)
        return out_path
    ...
    def retrieval_results_path(query_vector_file, repo_vector_file, max_top_k):
        print("query_vector_file", query_vector_file)
