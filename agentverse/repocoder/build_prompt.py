...
class BuildPromptWrapper:
    def __init__(self, vectorizer, benchmark, repos, window_size, slice_size, tokenizer):
        ...
        if benchmark == CONSTANTS.line_benchmark:
            ...
            self.task_path = FilePathBuilder.sim_assign_completion_benchmark
        elif benchmark == CONSTANTS.rand_benchmark:
            self.task_path = FilePathBuilder.rand_assign_completion_benchmark
        elif benchmark == CONSTANTS.ast_benchmark:
            self.task_path = FilePathBuilder.ast_assign_completion_benchmark
        elif benchmark == CONSTANTS.sim1_benchmark:
            self.task_path = FilePathBuilder.sim_assign1_completion_benchmark
