...
class GroundTruthWindowMaker:
    ...
    def build_window(self):
        ...
        print(f"*** gt {self.repo} {output_path}")
        Tools.dump_pickle(code_windows, output_path)
...
class MakeWindowWrapper:
    def __init__(self, benchmark, repos, window_sizes, slice_sizes):
        ...
        elif benchmark == CONSTANTS.sim_benchmark:
            self.task_file_path = FilePathBuilder.sim_assign_completion_benchmark
        elif benchmark == CONSTANTS.rand_benchmark:
            self.task_file_path = FilePathBuilder.rand_assign_completion_benchmark
        elif benchmark == CONSTANTS.ast_benchmark:
            self.task_file_path = FilePathBuilder.ast_assign_completion_benchmark
        elif benchmark == CONSTANTS.sim1_benchmark:
            self.task_file_path = FilePathBuilder.sim_assign1_completion_benchmark
